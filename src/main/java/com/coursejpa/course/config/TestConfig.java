...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2024-07-21T03:42:10Z"), OrderStatus.WATTING_PAYMENT, u2); 
		Order o3 = new Order(null, Instant.parse("2024-07-22T15:21:22Z"), OrderStatus.WATTING_PAYMENT, u1);
		...
		Payment pay1 = new Payment(null, Instant.parse("2024-10-20T20:00:00Z"), o1);
		o1.setPayment(pay1);
